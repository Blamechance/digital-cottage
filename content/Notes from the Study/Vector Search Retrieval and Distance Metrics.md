...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Euclidean Distance** | Measures the straight-line distance between two points (or the `hypotenuse`).                                                                                          | Absolute position difference               | Spatial data and clustering problems.<br><br>It's better for low-dimensional data and provides clear geometric interpretation, but loses accuracy in high-dimensional spaces.                                                                                                                              |
