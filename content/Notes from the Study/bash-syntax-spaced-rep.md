...
---
### Learning Resources: 
Skimming and pulling creating notes for TILs, to be used as spaced repetition cards with [this](https://github.com/st3v3nmw/obsidian-spaced-repetition) obsidian plug-in. 
...
The hash symbol `#` and the percent signs `%%` are used for parameter expansion in bash, allowing you to manipulate and extract parts of a variable's value.
